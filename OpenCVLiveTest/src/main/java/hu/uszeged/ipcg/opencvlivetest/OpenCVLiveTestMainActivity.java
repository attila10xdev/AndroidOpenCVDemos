package hu.uszeged.ipcg.opencvlivetest;
...
public class OpenCVLiveTestMainActivity extends AppCompatActivity implements CvCameraViewListener2 {
    ...
    private enum operationTypes { OPENCV_THRESH, JAVA_THRESH, JAVA_THRESH_32 }
    operationTypes mOpType;
    private int paramValue;
    private Mat workMat, retMat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opencv_live_test_main);
    ...
    private View.OnClickListener mBtn1Listener = new View.OnClickListener() {
        public void onClick(View v) {
            if( mOpType == operationTypes.OPENCV_THRESH ) {
                mOpType = operationTypes.JAVA_THRESH;
            } else {
                mOpType = operationTypes.OPENCV_THRESH;
            }
